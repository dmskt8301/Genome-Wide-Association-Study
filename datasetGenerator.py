...
# FROM YOUR UTA ID USING THIS SCRIPT, PLOT THE CORRECT MANHATTAN PLOT, THEN 
...
# generates a GWAS dataset unique to your 10 digit ID. To run the program, simply
# execute:
# >> python3 datasetGenerator.py --ID [your student ID]
# Execution of this code will generate a file [UTAID].csv
